...
def main():
    ...
    # make playlists
    scenes = ['sound\Intro_dance.ogg', "sound\direction_theme.ogg",
              "sound\game_over.ogg"]
    duck_songs = ['sound\main_theme_red_duck.ogg',
                  'sound\main_theme_yellow_duck.ogg',
                  'sound\main_theme_pink_duck.ogg']
